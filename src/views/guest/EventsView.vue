    ...
    <div class="pt-16 max-w-7xl mx-auto flex flex-col lg:flex-row">
      ...
      <aside class="hidden lg:block lg:w-64 bg-white border-r px-4 py-6 space-y-8">
        <div>
          ...
          <nav class="space-y-2">
            <a href="feed.html" class="flex items-center text-gray-600 hover:text-indigo-600">
            ...
            <router-link to = '/events' class="flex items-center text-indigo-600 font-medium">
              <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
      ...
      <main class="flex-1 px-4 sm:px-6 lg:px-8 py-6 space-y-8">
        <h1 class="text-2xl font-bold mb-6">Upcoming & Past Events</h1>
        ...
        <section class="bg-white rounded-lg shadow p-6">
          ...
          <div class="space-y-4">
            <div class="flex items-start justify-between bg-gray-50 p-4 rounded-md">
              <div>
                <h3 class="font-medium text-gray-800">AI in Education Webinar</h3>
                <p class="text-sm text-gray-500">Aug 18, 2025 · Online</p>
                <p class="text-sm text-gray-600 mt-1">A panel discussion on the impact of AI tools in modern classrooms.</p>
              </div>
              <div class="flex flex-col items-end space-y-2">
                <span class="text-xs bg-blue-100 text-blue-700 px-2 py-1 rounded-full">Live Soon</span>
                <button class="bg-indigo-600 text-white text-sm px-3 py-1 rounded-md hover:bg-indigo-700">Join</button>
              </div>
            </div>
            <div class="flex items-start justify-between bg-gray-50 p-4 rounded-md">
              <div>
                <h3 class="font-medium text-gray-800">Career Fair</h3>
                <p class="text-sm text-gray-500">Aug 22, 2025 · Campus Auditorium</p>
                <p class="text-sm text-gray-600 mt-1">Meet top employers and explore internship opportunities.</p>
              </div>
              <div class="flex flex-col items-end space-y-2">
                <span class="text-xs bg-yellow-100 text-yellow-700 px-2 py-1 rounded-full">Upcoming</span>
                <button class="bg-indigo-600 text-white text-sm px-3 py-1 rounded-md hover:bg-indigo-700">RSVP</button>
              </div>
            </div>
          </div>
        </section>
        ...
        <section class="bg-white rounded-lg shadow p-6">
          ...
          <div class="space-y-4">
            <div class="flex items-start justify-between bg-gray-50 p-4 rounded-md">
              <div>
                <h3 class="font-medium text-gray-800">Hackathon 2025</h3>
                <p class="text-sm text-gray-500">Jul 20–21, 2025 · Innovation Lab</p>
                <p class="text-sm text-gray-600 mt-1">24-hour coding event with prizes for best projects.</p>
              </div>
              <div class="flex flex-col items-end space-y-2">
                <span class="text-xs bg-green-100 text-green-700 px-2 py-1 rounded-full">Completed</span>
                <button class="bg-gray-200 text-gray-700 text-sm px-3 py-1 rounded-md cursor-not-allowed" disabled>Ended</button>
              </div>
            </div>
            <div class="flex items-start justify-between bg-gray-50 p-4 rounded-md">
              <div>
                <h3 class="font-medium text-gray-800">Mental Health Awareness Talk</h3>
                <p class="text-sm text-gray-500">Jul 10, 2025 · Wellness Center</p>
                <p class="text-sm text-gray-600 mt-1">Learn about strategies for managing academic stress.</p>
              </div>
              <div class="flex flex-col items-end space-y-2">
                <span class="text-xs bg-green-100 text-green-700 px-2 py-1 rounded-full">Completed</span>
                <button class="bg-gray-200 text-gray-700 text-sm px-3 py-1 rounded-md cursor-not-allowed" disabled>Ended</button>
